...
python run_limits_mc_new.py --toyn=$1 --input_file=$2 --length_scale=$3 --variance=$4  --mean=$5 --sigma=$6 --rate_uc=$7 --mean_err=$8 --sigma_err=$9 --nwalkers=${10} --steps=${11} --sig_strength=${12} --show_result=False --length_scale_err=${13} --variance_err=${14} --mc_uc=${15}